##' Dasst: a package for reading, processing and writing DSSAT files
##'
##' The \pkg{Dasst} (Dssat AS Simple Tables) package
##' provides methods for reading, processing and writing files
##' originally formatted for the DSSAT Crop Simulation Models.
##' 
##' The \pkg{Dasst} package defines the \code{\linkS4class{Dasst}}
##' class which enables to store the data
##' encoded for the DSSAT Crop Simulation Models as an S4 object,
